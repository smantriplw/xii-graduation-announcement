...
Route::prefix('siswa')->group(function () {
  ...
  Route::get('/', [GraduatedStudentController::class, 'all'])->middleware('auth:sanctum')->name('api.siswa');
  Route::post('/', [GraduatedStudentController::class, 'store'])->middleware('auth:sanctum')->name('api.siswa');
});
