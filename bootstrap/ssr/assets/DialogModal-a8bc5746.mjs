import { watch, onMounted, onUnmounted, computed, unref, useSSRContext, mergeProps, withCtx, createVNode, renderSlot } from "vue";
import { ssrRenderTeleport, ssrRenderStyle, ssrRenderClass, ssrRenderSlot, ssrRenderComponent } from "vue/server-renderer";
const _sfc_main$1 = {
  __name: "Modal",
