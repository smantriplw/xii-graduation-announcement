...
import { _ as _sfc_main$3 } from "./AppLayout-d1830e61.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<img${ssrRenderAttrs(mergeProps({
    src: "/images/logo.png",
    class: "object-contain h-64 lg:h-80"
  }, _attrs))}>`);
}
