...
import { _ as _sfc_main$1 } from "./AuthenticationCardLogo-7feaea9e.mjs";
      ...
      _push(ssrRenderComponent(AuthenticationCard, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              id: "register_token",
              modelValue: unref(form).token_registration,
              "onUpdate:modelValue": ($event) => unref(form).token_registration = $event,
              type: "text",
              class: "mt-1 block w-full",
              required: ""
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$4, {
              class: "mt-2",
              message: unref(form).errors.token_registration
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
